    ...
    if (empty($name) || empty($email) || empty($_POST['password'])) {
        ...
        if ($uploadOk == 0) {
            ...
            if (move_uploaded_file($_FILES["photo"]["tmp_name"], $target_file)) {
                $photo = "http://localhost/demo/uploads/". $_FILES["photo"]["name"];
            } else {
...
?>
        ...
        <form action="" method="post" enctype="multipart/form-data">
            ...
            <button type="submit" class="btn" onclick="return confirmAdd()">Add</button>

            <button type="button" class="button" onclick="location.href='display_data.php'">View Data</button>
